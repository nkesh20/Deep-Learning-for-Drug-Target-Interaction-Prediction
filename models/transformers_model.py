...
def build_transformer_model(config):
    ...
    drug_transformer = TransformerBlock(128, config['num_heads'], config['ff_dim'])(drug_embedding)
    drug_pooled = tf.keras.layers.GlobalAveragePooling1D()(drug_transformer)
    ...
    protein_transformer = TransformerBlock(128, config['num_heads'], config['ff_dim'])(protein_embedding)
    protein_pooled = tf.keras.layers.GlobalAveragePooling1D()(protein_transformer)
